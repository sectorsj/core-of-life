...
const CHAKRAS_CONFIG = [
  { key: "sahasrara", label: "Crown", color: "bg-purple-500", shadow: "shadow-purple-500/50" },
  { key: "ajna", label: "Third Eye", color: "bg-indigo-500", shadow: "shadow-indigo-500/50" },
  { key: "vishuddha", label: "Throat", color: "bg-blue-500", shadow: "shadow-blue-500/50" },
  { key: "anahata", label: "Heart", color: "bg-green-500", shadow: "shadow-green-500/50" },
  { key: "manipura", label: "Solar Plexus", color: "bg-yellow-500", shadow: "shadow-yellow-500/50" },
  { key: "svadhisthana", label: "Sacral", color: "bg-orange-500", shadow: "shadow-orange-500/50" },
  { key: "muladhara", label: "Root", color: "bg-red-500", shadow: "shadow-red-500/50" },
] as const;
  ...
  return (
    <div className="relative flex flex-col items-center justify-center py-12 gap-6 h-full min-h-[500px]">
      ...
      {CHAKRAS_CONFIG.map((chakra, index) => {
        ...
        const size = 30 + (value * 0.4); // Scale size based on value
        const opacity = 0.3 + (value / 100 * 0.7); // Opacity based on value
        ...
        return (
          ...
          >
            ...
            <motion.div
              ...
              transition={{
                duration: 4 + (index * 0.5), // Slower breathing
                repeat: Infinity,
                ease: "linear"
              }}
            />
